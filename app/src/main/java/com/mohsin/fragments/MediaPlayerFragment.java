...
import com.mohsin.R;
import com.mohsin.util.TestResponseObject;
...
public class MediaPlayerFragment extends BaseFragment {
    ...
    public static final String URL_VIDEO_MP4 =
            "https://k7q5a5e5.ssl.hwcdn.net/files/company/575729ad97f8152c41a96700/assets/videos/57bca0bf97f815217cd5784e/vod/57bca0bf97f815217cd5784e.m3u8";
    public static final String URL_IMAGE_ICON =
            "https://www.nema.org/_layouts/15/images/NEMA.Www.Master/NEMA-Logo.gif";
    ...
    private void playVideo() {
        ...
        MediaInfo mediaInfo = new MediaInfo.Builder(URL_VIDEO_MP4, "video/m3u8")
    ...
    public OnClickListener previousListener = new OnClickListener() {
        @Override
        public void onClick(View view) {
    ...
    public OnClickListener jumpListener = new OnClickListener() {
        @Override
        public void onClick(View view) {
            if (mPlaylistControl != null) {
    ...
    public OnClickListener rewindListener = new OnClickListener() {
        @Override
        public void onClick(View view) {
            if (mMediaControl != null)
    ...
    public OnClickListener fastForwardListener = new OnClickListener() {
        @Override
        public void onClick(View view) {
            if (mMediaControl != null)
